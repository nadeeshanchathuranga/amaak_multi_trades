...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('suppliers/{id}/invoices', [SupplierController::class, 'getInvoices'])->name('suppliers.invoices');
    Route::get('suppliers/{id}/payments', [SupplierController::class, 'showPayments'])->name('suppliers.payments');
    ...
    Route::post('/suppliers/payment', [SupplierController::class, 'supplierPayment'])->name('suppliers.payment');
